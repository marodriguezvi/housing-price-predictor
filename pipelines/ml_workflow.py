...
def train_and_save_model(
    ...
    try:
        ...
        output_path = Path(f"{MODEL_DIR}/model_{version}.pkl")
...
def evaluate_model(
    ...
    Args:
        ...
        version (str): Version label of the model (used for saving results).
    ...
    results_path = f"{MODEL_DIR}/evaluation_{version}.json"
    results = {
